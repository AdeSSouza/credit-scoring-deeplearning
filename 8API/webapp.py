...
#listas de variaveis categoricas para o usuario selecionar na aplicacao web
...
#criando formulario no streamlit com controles de valores nao existentes,
#controles de variaveis categoricas(selectbox) e variaveis numericas(number_input min e max).
...
#montando dicionario, fazendo requisicao e mostrando resultado
if submit_button:
    dados_novos = {
        'profissao': [profissao],
    ...
    #requisao url cpm json dados novos
